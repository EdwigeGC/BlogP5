                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="published" name="published" value="Publié" required
                             <?php if (isset($resultat['published'])){
                                        if ($resultat['published']== "Publié"){?>
                                        checked
                                        <?php }}?>>
                    ...
                    <div class="col-md-6">
                        <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="no-published" name="published" value="Non publié" required
                            <?php if (isset($resultat['published'])){
                                        if ($resultat['published']== "Non publié"){?>
                                        checked
                                        <?php }
                                        }?>>
